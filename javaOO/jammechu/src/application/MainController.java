...
public class MainController {
	...
	// 메뉴 리스트
	private static final List<String> MENU_LIST = Arrays.asList("국밥", "김밥", "냉면", "돈까스", "떡볶이", "삼겹살", "초밥", "치킨",
			"햄버거");
	// 랜덤 객체
	...
	public void initialize() {
		setTimer();
		//butten.setOnAction(e -> Buttonclick());
	}
	...
	void setTimer() {
		// Timeline 주기적으로 처리할 수 있도록 하는 애니메이션 클래스
				timeline = new Timeline(
					...
					// * Duration.millis(밀리초)	- 여기서는 0.015초
