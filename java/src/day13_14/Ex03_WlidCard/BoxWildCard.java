package day13_14.Ex03_WlidCard;

import day04.Class.Pikachu;
import day04.Class.Raichu;

/**
 * 제네릭 와일드카드 - 알 수 없는 타입을 대체하여 사용하는 기호 - 주로 타입 제한을 주기 위해서 사용한다. 1) ? super T :
 * 해당 클래스부터 상위 클래스를 허용하도록 제한 2) ? extends T : 해당 클래스부터 하위 클래스를 허용하도록 제한
 */
public class BoxWildCard {
	public static void main(String[] args) {
		...
		wBox2=box2_a;
		wBox2=box2_b;
//		Box<? extends Number> wBox2_2 = box1;// (에러)
